---
title: "[OLD] Zapffe: Our Undesirable Instinct of Hope"
date: "2023-04-09"
description: "How biological instinct only leads to mistaken optimism in service of reproduction"
categories: [philosophy, pessimism, analysis]
image: "zapffe-portrait.webp"
draft: false
---
...
![Portrait of Peter Wessel Zapffe (1949)](zapffe-portrait.webp)

Zapffe's masterwork is his essay "The Last Messiah," originally published in 1933. If you would like to read it, the online version [can be found here](https://philosophynow.org/issues/45/The_Last_Messiah). It's only roughly four pages in length, so I highly recommend it if you want to indulge in a pessimism-filled fantasy.
...
Zapffe's primary rhetorical tool is the allegory of the [Irish elk](https://en.wikipedia.org/wiki/Irish_elk), an extinct species of deer that had the largest antlers in deer history. Zapffe remarks how these deer succumbed to their own biology. The antlers served some positive purpose to be evolutionarily selected for but also served as a burden to the deer, who had to carry the physical weight. Eventually, the antlers became too large and became more of a detriment than a benefit. If the Irish elk's antlers had not evolved to be so large, they might not have died out.

![A depiction of a doe and buck Irish Elk](irish-elk.webp)
...
Stepping aside for a slight tangent, I personally take issue with Zapffe's allegory here because antlers are a [sexually selected](https://www.nature.com/scitable/knowledge/library/sexual-selection-13255240/) trait, which even [Darwin noted](https://www.nature.com/scitable/knowledge/library/sexual-selection-13255240/) often works at the expense of the animal's survival. So it surprises me that a self-stated naturalist would use antlers as an example. Moreover, the Irish elk's extinction was likely caused by multiple factors. After all, the Irish elk was only one of the many animals who died out during the end of the Pleistocene era. Not to mention that only the bucks bore antlers. To be fair to Zapffe, he probably based his argument on the [popular conception](https://uwaterloo.ca/wat-on-earth/news/irish-elk-victim-or-success) of the elk's fate at the time.
...
The **first** coping mechanism is what he calls *isolation*. He describes this as, "a fully arbitrary dismissal from consciousness of all disturbing and destructive thought and feeling." This amounts to dodging the question or a *best to not think about it* mindset. Zapffe says how this can become a societal practice as society can also isolate certain ideas by sterilizing our surroundings with ideas of death.
...
![A giraffe splaying its legs while drinking](giraffe.webp)
...
Zapffe's solution is [antinatalism](https://en.wikipedia.org/wiki/Antinatalism) — the refusal of procreation. Natural selection cursed us to become existentially awakened and deluded us into believing in purpose. However, it only cared about the preservation of the genome and was content to feed us lies to keep us breeding. The only act we can do to overcome our nature is to refuse to play this game. Once humanity intentionally dies out, we will have finally bested our biological natures and provided our own ending to the pre-written story that evolution was crafting for us.
...
![Three types of DNA replications: Binary fission, Mitosis, and Meiosis](dna-replication.webp)

There are several potential objections to Zapffe's argument. One might wonder if the natural selection-inclined solutions to the problem are actually wrong. Just because they are defense mechanisms does not mean they lack inherent meaning. Additionally, it is unclear whether Zapffe sufficiently justifies why we should deny our evolved natural instincts. He seems to believe that natural selection being responsible for existential awareness is enough justification for us to not trust the coping mechanisms it has supplied us.

Perhaps these questions and more were discussed in *On the Tragic*, but unless I learn Norwegian or can convince my Norwegian friend to translate it for me, I will have to wait until an official published translation becomes available.
